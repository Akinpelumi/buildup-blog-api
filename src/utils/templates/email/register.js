  ...
  <body>
    <div style="
      ...
      <p style="margin: 0; padding: 0">
        Welcome to BuildUp Blogs! Please enter the code below to complete your account setup:
      </p>

      <br />
      <p style="margin: 0; padding: 0; font-size: 40px; font-family: Nunito Sans; font-weight: bold;">
        ${data.otp}
      </p>
      <br />
      <p style="margin: 0; padding: 0">
        This code will expire in ${data.otp_duration} minutes.
      </p>
      <br />
      <p style="margin: 0; padding: 0">
